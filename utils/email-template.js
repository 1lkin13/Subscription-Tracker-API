export const emailTemplates = [
    {
        ...
        generateSubject: (data) =>
            `🎉 Your ${data.subscriptionName} Subscription Has Been Created!`,
        generateBody: (data) =>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #ffffff; border-radius: 10px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
        ...
        <tr>
            <td style="padding: 40px 30px;">                
                ...
                ${
    daysLeft === 'N/A'
        ? `<p style="font-size: 16px; margin-bottom: 25px;">Thank you for subscribing to <strong>${subscriptionName}</strong>! Your subscription starts on <strong style="color: #4a90e2;">${renewalDate}</strong>.</p>`
